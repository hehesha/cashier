...
var Main = (function () {
  ...
  var setLayoutStyle = function () {
    $('select[name="layout"]').change(function () {
      if ($('select[name="layout"] option:selected').val() == 'boxed') { $('body').addClass('layout-boxed') } else { $('body').removeClass('layout-boxed') }
    })
  }
  var setHeaderStyle = function () {
    $('select[name="header"]').change(function () {
      if ($('select[name="header"] option:selected').val() == 'default') { $('body').addClass('header-default') } else { $('body').removeClass('header-default') }
    })
  }
  var setFooterStyle = function () {
    $('select[name="footer"]').change(function () {
      if ($('select[name="footer"] option:selected').val() == 'fixed') { $('body').addClass('footer-fixed') } else { $('body').removeClass('footer-fixed') }
    })
  }
